...
Neste notebook trabalheremos com o treinamento e exportação do modelo, enquanto o aplicativo do streamlit ficará dentro do app.py, e a exploração dos dados no notebook xxx
